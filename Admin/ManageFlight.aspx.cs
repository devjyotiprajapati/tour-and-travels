...
public partial class ManageFlight : System.Web.UI.Page
{
    ...
    public void connect()
    {
        ...
        string qry = "select *from Flight ";//SQL Query
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["dbcon"].ConnectionString);//create DB Connection
        con.Open();//open DB connection
        string qry = "delete from Flight where Flightno=@12";//SQL Query
        SqlCommand cmd = new SqlCommand(qry, con);//Send Query for execution
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string qry = "update Flight set Flightname=@t1,Startcity=@t2,Lastcity=@t3,Dayofruning=@t4 where Flightno=@t5";//SQL Query
        SqlCommand cmd = new SqlCommand(qry, con);//Send Query for execution
