...
public partial class SearchTrainByNumber : System.Web.UI.Page
{
    ...
    protected void btn_Click1(object sender, EventArgs e)
    {
        ...
        string qry = "select *from Train where Trainno=@12";//SQL Query
        ...
        if (dr.HasRows)//If data Meet in dr
        {
            dr.Read();
            Panel1.Visible = true;
            TextBox2.Text = dr["Trainname"].ToString();
        ...
        {
            Label1.Visible = true;
            Label1.Text = "Train ID not found";
        }
        }
