...
public partial class SearchTrainByDestination : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "select *from Train where Startstation=@t1 and Laststation=@t2";//SQL Query
            ...
            {
                Label1.Visible = true;
                Label1.Text = "To and From destination not found";
            }
