<%@ Page Title="" Language="C#" MasterPageFile="~/TrainMaster.master" AutoEventWireup="true" CodeFile="CancelTrainTicket.aspx.cs" Inherits="CancelTrainTicket" %>
     ...
     <div  class="container-fluid box ">
        <div class="row">
            ...
            <div class="col-md-4 col-ms-4 col-xs-12 body">
                <h1>Train Ticket Cancelation</h1>
            ...
            <div class="col-md-4 col-ms-4 col-xs-12">
                <img src="Images/Train1.jpg" class="rounded float-right img" alt="..." height="500" width="300">
            </div>
            </div>
