...
public partial class SearchFlightByName : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string qry = "select *from Flight where Flightname=@t1";//SQL Query
        ...
        {
            Label1.Visible = true;
            Label1.Text = "Flight name not found";
        }
        }
