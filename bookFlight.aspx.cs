...
public partial class bookFlight : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string qry = "select max(Bookid) from Flightbook";//SQL Query
    ...
    protected void bt1_Click(object sender, EventArgs e)
    {
        ...
        string qry = "insert into Flightbook values(@t1,@t2,@t3,@t4,@t5,@t6,@t7)";//SQL Query
        SqlCommand cmd = new SqlCommand(qry, con);//Send Query for execution
        ...
        {
            Label7.Visible = true;
            Label7.Text = "Record Saved SuccesFully";
        }
