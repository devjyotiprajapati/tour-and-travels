...
public partial class BookTrain : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string qry = "select max(Trainbid) from Trainbook";//SQL Query
    ...
    protected void bt1_Click(object sender, EventArgs e)
    {
        ...
        string qry = "insert into Trainbook values(@t1,@t2,@t3,@t4,@t5,@t6,@t7)";//SQL Query
        SqlCommand cmd = new SqlCommand(qry, con);//Send Query for execution
        cmd.Parameters.AddWithValue("@t1", TextBox3.Text);//Passing Paramiters to the Query
        ...
        cmd.Parameters.AddWithValue("@t6", DropDownList4.Text);
