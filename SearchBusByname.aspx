<%@ Page Title="" Language="C#" MasterPageFile="~/Bus.master" AutoEventWireup="true" CodeFile="SearchBusByname.aspx.cs" Inherits="SearchBus" %>
    ...
    <div  class="container-fluid box ">
        <div class="row">
            <div class="col-md-4 col-ms-4 col-xs-12">
                   <img src="Images/search5.jpg" class="rounded float-left img" alt="..." height="500" width="300"/>
            </div>
                ...
                <div class="form-group">
                    ...
                    <table class="auto-style1">
                        <tr>
                            ...
                            <td>
                                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" Text="Search" Class="btn btn-primary" />
            ...
            <div class="col-md-4 col-ms-4 col-xs-12">
                <img src="Images/Bus3.jpg" class="rounded float-right img" alt="..." height="500" width="300">
            </div>
        </div>
    </div>
