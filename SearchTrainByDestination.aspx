<%@ Page Title="" Language="C#" MasterPageFile="~/TrainMaster.master" AutoEventWireup="true" CodeFile="SearchTrainByDestination.aspx.cs" Inherits="SearchTrainByDestination" %>
    ...
    <div  class="container-fluid box ">
        <div class="row">
            <div class="col-md-4 col-ms-4 col-xs-12">
                <img src="Images/search5.jpg" class="rounded float-left img" alt="..." height="600" width="300"/>
            </div>
            <div class="col-md-4 col-ms-4 col-xs-12 body">
                <h1>Search Train By Destination </h1>
            ...
            <div class="col-md-4 col-ms-4 col-xs-12">
                <img src="Images/Tain.jpg" class="rounded float-right img" alt="..." height="600" width="300"/>
            </div>
        </div>
    </div>
